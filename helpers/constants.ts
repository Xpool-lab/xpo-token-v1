...
export const XPO_GORVERNANCE: tEthereumAddress = '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE';
...
export const getXpoolTokenDomainSeparatorPerNetwork = (
...
// XpoolProtoGovernance address as admin of XPOToken and Migrator
export const getXpoolAdminPerNetwork = (network: eEthereumNetwork): tEthereumAddress =>
  getParamPerNetwork<tEthereumAddress>(
    {
